		...
		<!-- Banner -->
			<section class="banner container">
				<div class="photo-banner">
					...
					<div class="descr-banner text-center">
			...
			<c:url var="get_search_url" value="search"/>
				<form action="${get_search_url}" id="myform" method="get" class="form-inline text-center" style="padding:20px;">

						<input class="form-control mr-sm-2" type="search"
							placeholder="Search" value="" name="keyword" required="true"/>
