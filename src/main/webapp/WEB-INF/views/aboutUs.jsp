...
<head>
<title>About Us - ABC Car Portal</title>
<!--  Enable Bootstrap -->
<link rel="stylesheet"
      ...
      <div class="screen-body">
        <div class="screen-body-item center">
          <div class="app-title">
			...
			<h2>WE HELP YOU GET A GREAT DEAL ON A CAR !</h2>
			...
			<h4>We also help buyers with less-than-perfect credit find special
				financing options through our network of trusted lending partners.</h4>
			<p class="lead">
